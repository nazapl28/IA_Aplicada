# Comparativo de camadas dos fornecedores

> Peça do núcleo. Extraída de Apêndice E e cap. 3.6 do livro de conselhos.
> Vale para qualquer setor. Alteração aqui repercute em todos os livros.
> Última revisão do conteúdo: agosto de 2026.

> **Generalização pendente.** Este texto ainda usa vocabulário do primeiro livro: plenário (1). Ao reusar em outro setor, troque os termos. Não foi feita substituição automática porque várias passagens descrevem etapas próprias do processo ético.
...
| Ferramenta | Camada de consumo | Camada corporativa |
|---|---|---|
| ChatGPT | Conteúdo pode ser usado para treinar modelos; desativação manual em Data Controls | ChatGPT Business, Enterprise e API: sem treinamento sobre conteúdo do cliente por padrão |
| Claude | Uso para treinamento depende de o usuário permitir; retenção de até 5 anos em pipeline quando permitido | Claude for Work e API: sem treinamento por padrão; administrador pode desativar o botão de avaliação |
| Gemini | Atividade retida por 18 meses por padrão; revisão humana de parte das conversas | Camada corporativa contratada, sujeita às condições do contrato de serviço |
| Copilot | Dados de consumo usados para treinar modelos generativos, com opção de recusa | Microsoft 365 Copilot: prompts, respostas e dados do Microsoft Graph não treinam modelos de fundação |
